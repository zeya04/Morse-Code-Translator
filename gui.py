...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.text1_1.configure(highlightbackground="grey")
        ...
        self.Button1_2.configure(activebackground="black")
        ...
        self.Button1_2.configure(highlightcolor="white")
        self.Button1_2.configure(pady="0")
        self.Button1_2.configure(text='''Decrypt''',command=get)

        self.Label1 = tk.Label(top)
        self.Label1.place(relx=0.325, rely=0.067, height=30, width=400)
        self.Label1.configure(background="teal")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(foreground="black")
        self.Label1.configure(text='''Morse Code Translator''',font=("Times New Roman",30))

        self.Label2 = tk.Label(top)
        self.Label2.place(relx=0.1, rely=0.283, height=26, width=252)
        self.Label2.configure(background="teal")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(foreground="#000000")
        self.Label2.configure(text='''INPUT''',font=("Times New Roman",15,'bold'))
        ...
        self.Label3.configure(background="teal")
        self.Label3.configure(disabledforeground="#a3a3a3")
        self.Label3.configure(foreground="#000000")
        self.Label3.configure(text='''OUTPUT''',font=("Times New Roman",15,'bold'))
